...
const NavBar = () => {
  return (
    <div className='fixed left-1/2 transform -translate-x-1/2 translate-y-2/2 z-15'>
        <GlassCard>
            <ButtonGroup className='border border-white/20 rounded-xl'>
                <Link href="/">
                    <Button className='hover:bg-white/10 rounded-r-none'>
                ...
                <Link href="mailto:abobich675@gmail.com">
                    <Button className='hover:bg-white/10 rounded-l-none'>
