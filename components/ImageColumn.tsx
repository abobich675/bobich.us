...
const ImageColumn = ({ images, children}: ImageColumnProps) => {
    return (
        <div className='pt-10 text-lg flex gap-5 lg:gap-20'>
            <div className='w-full text-gray-400 text-xs lg:text-base'>
                {children}
            </div>
            <div className='p-5 sm:p-12.5 lg:p-20 pt-5 sm:pt-5 lg:pt-5'>
                {images.map((src, idx) => 
                {
                    ...
                    return (
                      <div key={idx}>
                        {/* Small */}
                        <div className="sm:hidden shrink-0 justify-end">
                          {isGif ? (
                        ...
                        {/* Medium */}
                        <div className="hidden sm:block lg:hidden shrink-0 justify-end">
                          {isGif ? (
                        ...
                        {/* Large */}
                        <div className="hidden lg:block shrink-0 justify-end">
                          {isGif ? (
