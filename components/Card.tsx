...
const Card = ({ icon, header, description}: CardProps) => {
    return (
        <>
            ...
            {/* Medium */}
            <div className="hidden md:flex lg:hidden relative rounded-3xl bg-white outline-2 outline-gray-300 w-45 h-60 p-5 pt-2 pb-0 flex-col justify-between" >
                <div className='flex justify-center'>
            ...
            {/* Large */}
            <div className="hidden lg:flex relative rounded-3xl bg-white outline-2 outline-gray-300 w-60 h-80 p-7.5 pt-5 pb-0 flex-col justify-between" >
                <div className='flex justify-center'>
