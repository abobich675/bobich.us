...
const Card = ({ icon, header, description}: CardProps) => {
    return (
        <>
            {/* Small */}
            <div className="md:hidden relative rounded-3xl bg-white border-2 border-gray-300 w-30 h-40 p-2.5 pt-2 pb-0 flex flex-col justify-between" >
            ...
            {/* Medium */}
            <div className="hidden md:flex lg:hidden relative rounded-3xl bg-white border-2 border-gray-300 w-45 h-60 p-5 pt-2 pb-0 flex-col justify-between" >
                <div className='flex justify-center'>
            ...
            {/* Large */}
            <div className="hidden lg:flex relative rounded-3xl bg-white border-2 border-gray-300 w-60 h-80 p-7.5 pt-5 pb-0 flex-col justify-between" >
                <div className='flex justify-center'>
